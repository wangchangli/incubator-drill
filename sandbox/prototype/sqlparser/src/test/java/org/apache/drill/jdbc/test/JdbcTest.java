...
public class JdbcTest extends TestCase {
  ...
  public void testSelectJson() throws Exception {
    ...
    final ResultSet resultSet = statement.executeQuery(
        "select * from donuts");
//      final ResultSet resultSet = statement.executeQuery(
//              "select * from donuts where cast(id as varchar(10)) = '0004'");
    assertEquals(
    ...
    /** Simple query against JSON. */
  public void testSelectJson2() throws Exception {
    Class.forName("org.apache.drill.jdbc.Driver");
    final Connection connection = DriverManager.getConnection(
            "jdbc:drill:schema=donuts;tables=donuts");
    final Statement statement = connection.createStatement();
    final ResultSet resultSet = statement.executeQuery( "select * from donuts");
    }
